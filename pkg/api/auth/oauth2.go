// Package auth is the auth package for the rabbit service.
package auth
...
const (
	...
	OperationOAuth2Reports = "/rabbit.api.auth.OAuth2/OAuth2Reports"
)
...
type (
	...
	OAuth2LoginFun            func(ctx http.Context, oauthConfig *oauth2.Config) (User, error)
	RedirectURLFunc           func(ctx http.Context, oauthConfig *oauth2.Config, user User) (string, error)
)
